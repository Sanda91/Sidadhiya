...
//import com.androidexample.gcm.RegisterActivity.LoadProfileImage;
...
ConnectionCallbacks, OnConnectionFailedListener {
	...
	private TextView txtsName, txtsEmail;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// settings = getSharedPreferences(RegisterActivity.PREFS_NAME, 0);
		...
		/*if(hasLoggedIn)
		{
			...
			intent.setClass(RegisterActivity.this, TabListView.class);
		...
		btnRegister.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {  
				...
				if(name.trim().length() > 0 && email.trim().length() > 0){
					...
					Intent i = new Intent(getApplicationContext(), TabListView.class);
		...
		txtsEmail = (TextView) findViewById(R.id.txtsEmail);
